...
var titlerComponent = Vue.component('titler-component', { 
    ...
    <div class="card-header accordion-header-root">
       <button data-toggle="collapse" href="#collapseTitler" aria-expanded="true" class="btn btn-link btn-block btn-accordion-root text-left hover-button-delta" data-dashlane-rid="ff97582e223a8c12" data-dashlane-label="true" data-form-type="other">
          ...
          <span class="accordion-title-root">1 fremføring</span>
       </button>
    </div>
       ...
       <div class="accordion-header-sub card-body items-oversikt">
          <div>
             <div class="item titel">
                ...
                <div class="buttons">
                   <button data-toggle="collapse" :href="[ '#editTittel' + tittel.id ]" aria-expanded="true" class="small-button-style hover-button-delta mini edit-user-info collapsed" data-dashlane-rid="a30c1df0b74e284d" data-dashlane-label="true" data-form-type="other">
                   ...
                   <button class="small-button-style hover-button-delta mini remove-person-button" data-dashlane-rid="402858aada271ba8" data-dashlane-label="true" data-form-type="other">
             ...
             <div :id="[ 'editTittel' + tittel.id ]" class="collapse edit-user-form">
                <div class="item new-person">
                   ...
                   <div class="form-new-user">
                        ...
                        <!-- tekst_av -->
                        <div v-if="tittel.tekst_av" class="input-delta open">
                            <div class="overlay">
                                <div class="info">
                                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style="fill: #A0AEC0;transform: ;msFilter:;"><path d="M7.5 6.5C7.5 8.981 9.519 11 12 11s4.5-2.019 4.5-4.5S14.481 2 12 2 7.5 4.019 7.5 6.5zM20 21h1v-1c0-3.859-3.141-7-7-7h-4c-3.86 0-7 3.141-7 7v1h17z"></path></svg>
                                    <span class="text">Medforfattere</span>
                                </div>
                            </div>
                            <input v-model:value="tittel.tekst_av" type="text" class="input" name="tekst_av">
                        </div> 

                        <!-- litteratur_read -->
                        <div v-if="tittel.litteratur_read != undefined" class="input-delta open">
                            <div class="overlay">
                                <div class="info">
                                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style="fill: #A0AEC0;transform: ;msFilter:;"><path d="M7.5 6.5C7.5 8.981 9.519 11 12 11s4.5-2.019 4.5-4.5S14.481 2 12 2 7.5 4.019 7.5 6.5zM20 21h1v-1c0-3.859-3.141-7-7-7h-4c-3.86 0-7 3.141-7 7v1h17z"></path></svg>
                                    <span class="text">Medforfattere</span>
                            ...
                            <input v-model:value="tittel.litteratur_read" type=”radio” checked class="input" name="litteratur_read">
                        </div> 

                        <!-- litteratur_read -->
                        <div v-if="tittel.litteratur_read == true" class="input-delta open">
                            <div class="overlay">
                                <div class="info">
                                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style="fill: #A0AEC0;transform: ;msFilter:;"><path d="M7.5 6.5C7.5 8.981 9.519 11 12 11s4.5-2.019 4.5-4.5S14.481 2 12 2 7.5 4.019 7.5 6.5zM20 21h1v-1c0-3.859-3.141-7-7-7h-4c-3.86 0-7 3.141-7 7v1h17z"></path></svg>
                                    <span class="text">Medforfattere</span>
          ...
          <div id="newTittelCollapse" class="new-user-form collapse" style="">
             <div class="item new-tittel">
               <div class="user-empty">
                   <div class="buttons">
                      <button data-toggle="collapse" href="#newTittelCollapse" aria-expanded="false" class="small-button-style hover-button-delta mini go-to-meld-av collapsed" data-dashlane-rid="67b45728ba08e8f1">
                         <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="5 1 25 25" style="fill: rgb(255, 255, 255);">
                            <path d="m16.192 6.344-4.243 4.242-4.242-4.242-1.414 1.414L10.535 12l-4.242 4.242 1.414 1.414 4.242-4.242 4.243 4.242 1.414-1.414L13.364 12l4.242-4.242z"></path>
                         </svg>
                      </button>
               ...
               <button class="small-button-style new-member hover-button-delta" data-dashlane-rid="74ce79764e10a49a">
                Fullfør og legg til
                </button>
             </div>
          </div>
    ...
    <div class="new-member-div">
        <button data-toggle="collapse" href="#newTittelCollapse" aria-expanded="false" class="small-button-style new-member add-new hover-button-delta collapsed" data-dashlane-rid="322cd5125d51f808" data-dashlane-label="true" data-form-type="other">
        Legg til fremføring
